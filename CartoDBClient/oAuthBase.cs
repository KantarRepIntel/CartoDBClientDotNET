...
namespace CartoDBClient
{
    public class OAuthBase
    {
        ...
        public string UrlEncodeWithoutSpecialChars(string value)
        {
        ...
        /// <param name="value">The value to Url encode</param>
        /// <returns>Returns a Url encoded string</returns>
        public string UrlEncodeOnlySpecialChars(string value)
        {
            if (string.IsNullOrEmpty(value))
            {
                return string.Empty;
        ...
        public string GenerateSignatureBase(Uri url, string consumerKey, string token, string tokenSecret, string verifier, string xAuthUsername, string xAuthPassword, string httpMethod, string timeStamp, string nonce, string signatureType, out string normalizedUrl, out string normalizedRequestParameters, bool apiRequest = false)
        {
            if (token == null)
            {
                token = string.Empty;
            ...
            signatureBase.AppendFormat("{0}&", UrlEncode(UrlEncodeOnlySpecialChars(normalizedUrl)));
            signatureBase.AppendFormat("{0}", UrlEncode(UrlEncodeOnlySpecialChars(normalizedRequestParameters)));
